...
export const COLUMNS = [
    ...
    {display_name: "Percentage funded", key: "percentage.funded" , formatter: (val, maxlen) => `${val}`.padStart(maxlen, "0"),  }, 
    {display_name: "Amount pledged", key: "amt.pledged", formatter: (val, maxlen) => `${val}`.padStart(maxlen, "0") }
]
